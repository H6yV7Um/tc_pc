...
function(e, t) {
	...
	h.extend({
      ...
      var t, n = Gt.propHooks[this.prop];
			return this.options.duration ? this.pos = t = e : this.pos = t = e, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : Gt.propHooks._default.set(this), this
		}
