...
var LotteryMain = function() {
	...
	var Layout = [{
		...
		rows: [[{
			...
			columns: [{
				...
				example: '如：选择后二大小单双“小双”，<br>开奖号码十位与个位为“小双”，即为中奖。',
				help: '对十位、个位的“大（56789）小（01234）、单（13579）双（02468）”形态进行购买，所选号码的位置、形态与开奖号码的位置、形态相同，即为中奖。',
				select: {
          layout: [{
            title: '十位',
            balls: ['大', '小', '单', '双']
            ...
            balls: ['大', '小', '单', '双']
				...
				realname: '[不定胆_后三二码]',
				tips: '从百位、十位中的“大、小、单、双”中至少各选一个组成一注。',
				example: '如：选择前二大小单双“大单”，<br>开奖号码百位与十位为“大单”，即为中奖。',
    ...
    var vback = callback;
        ...
        LotteryRecord.add(issue, method, compress, content, num, multiple, model, code, point, total, vback);
				PlayArea.reset();
			});
		} else {
