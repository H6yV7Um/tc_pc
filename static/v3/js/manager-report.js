...
var PopOrder = function () {
    ...
    var details = function (id, thisContent, callback, isAgent) {
        ...
        Will.ajax({billno: id}, url, function (data) {
            Will.initBox('订单详情', initDoc(data), 740, 520, function () {
...
var initThisPage04_rpt = function () {
    //团队报表 个人报表
    //console.log('initThisPage04_rptinitThisPage04_rpt');
    var tabs = [initThisPage01_rpt];//[initThisPage02_rpt, initThisPage01_rpt]
...
var initThisPage06_rpt = function () {
    ...
    Will.page(thisContent06, getSearchParams, Route.PATH + '/account/search-zbrecord', '没有查询到相关记录', function (list) {
        ...
        thisResultTable.find('a[data-command="remarks"]').jBox('Tooltip', {
...
var initReport = function () {
    ...
    Will.changeTabs([initThisPage04a_rpt, initThisPage05_rpt, initThisPage06_rpt, null, initThisPage04_rpt, initThisPage04a_rpt_vr, initThisPage08_rpt, null]);
}
